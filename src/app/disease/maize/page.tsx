...
const translations = {
  en: {
    ...
    error: 'Failed to detect maize disease. Please try again.',
    detectionResult: 'Detection Result:',
  },

  es: {
    title: 'मक्का की बीमारी का पता लगाना',
    analyzing: 'छवि का विश्लेषण किया जा रहा है...',
    error: 'मक्का की बीमारी का पता लगाने में विफल। कृपया पुनः प्रयास करें।',
...
export default function PotatoDiseaseDetection() {
    ...
    const handleUpload = async (file: File) => {
        ...
        try {
            const response = await fetch("/api/disease/maize", {
                method: "POST",
                body: formData,
            });

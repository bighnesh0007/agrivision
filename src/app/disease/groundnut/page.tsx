...
const translations = {
  en: {
    ...
    error: 'Failed to detect groundnut disease. Please try again.',
    detectionResult: 'Detection Result:',
  },
 
  es: {
    title: 'मूँगफली की बीमारी का पता लगाना',
    analyzing: 'चित्र का विश्लेषण किया जा रहा है...',
    error: 'मूँगफली की बीमारी का पता लगाने में विफल। कृपया पुनः प्रयास करें।',
...
export default function PotatoDiseaseDetection() {
    ...
    const handleUpload = async (file: File) => {
        ...
        try {
            const response = await fetch("/api/disease/groundnut", {
                method: "POST",
                body: formData,
            });

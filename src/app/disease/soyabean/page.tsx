...
const translations = {
  en: {
    title: 'Soyabean Disease Detection',
    analyzing: 'Analyzing image...',
    error: 'Failed to detect soyabean disease. Please try again.',
    detectionResult: 'Detection Result:',
  },

  es: {
    title: 'सोयाबीन रोग पहचान',
    analyzing: 'चित्र का विश्लेषण किया जा रहा है...',
    error: 'सोयाबीन रोग का पता लगाने में विफल। कृपया पुनः प्रयास करें।',
    detectionResult: 'पता लगाने का परिणाम:',
  },
  th: {
    title: 'การตรวจจับโรคถั่วเหลือง',
    analyzing: 'กำลังวิเคราะห์ภาพ...',
    error: 'ไม่สามารถตรวจจับโรคถั่วเหลืองได้ กรุณาลองอีกครั้ง',
...
export default function SoyabeanDiseaseDetection() {
    ...
    const handleUpload = async (file: File) => {
        ...
        try {
            const response = await fetch("/api/disease/soyabean", {
                method: "POST",
                body: formData,
            });

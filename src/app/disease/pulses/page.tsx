...
const translations = {
  en: {
    title: 'Pulses Disease Detection',
    analyzing: 'Analyzing image...',
    error: 'Failed to detect pulses disease. Please try again.',
  ...
  es: {
    ...
    error: 'दाल रोग का पता लगाने में विफल। कृपया पुनः प्रयास करें।',
    detectionResult: 'पता लगाने का परिणाम:',
  },
  th: {
    title: 'การตรวจจับโรคถั่ว',
    analyzing: 'กำลังวิเคราะห์ภาพ...',
    error: 'ไม่สามารถตรวจจับโรคถั่วได้ กรุณาลองอีกครั้ง',
...
export default function RiceDiseaseDetection() {
    ...
    const handleUpload = async (file: File) => {
        ...
        try {
            const response = await fetch("/api/disease/pulses", {
                method: "POST",
                body: formData,
            });

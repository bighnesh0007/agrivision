...
const translations =  {
    en: {
      title: 'Lemon Disease Detection',
      analyzing: 'Analyzing image...',
      error: 'Failed to detect lemon disease. Please try again.',
      detectionResult: 'Detection Result:',
    },
    es: {
        title: 'नींबू की बीमारी का पता लगाना',
        analyzing: 'चित्र का विश्लेषण किया जा रहा है...',
        error: 'नींबू की बीमारी का पता लगाने में विफल। कृपया पुनः प्रयास करें।',
        detectionResult: 'पता लगाने का परिणाम:',
    },
    // Add more languages here
  };

export default function LemonDiseaseDetection() {
    ...
    const handleUpload = async (file: File) => {
        ...
        try {
            const response = await fetch("/api/disease/lemon", {
                method: "POST",
                body: formData,
            });

            if (!response.ok) {
                throw new Error("Failed to detect lemon disease");
            }

...
const translations = {
  en: {
    ...
    error: 'Failed to detect cotton disease. Please try again.',
    detectionResult: 'Detection Result:',
  },

  es: {
    title: 'कपास की पत्तियों की बीमारी का पता लगाना',
    analyzing: 'चित्र का विश्लेषण किया जा रहा है...',
    error: 'कपास की बीमारी का पता लगाने में विफल। कृपया पुनः प्रयास करें।',
    detectionResult: 'पता लगाने का परिणाम:',
  },
};

export default function CottonLeafDiseaseDetection() {
    ...
    const handleUpload = async (file: File) => {
        ...
        try {
            const response = await fetch("/api/disease/cotton-leaf", {
                method: "POST",
                body: formData,
            });

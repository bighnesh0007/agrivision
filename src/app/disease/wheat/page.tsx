...
const translations = {
  en: {
    ...
    error: 'Failed to detect wheat disease. Please try again.',
    detectionResult: 'Detection Result:',
  },
  
  es: {
    title: 'गेहूं रोग पहचान',
    analyzing: 'चित्र का विश्लेषण किया जा रहा है...',
    error: 'गेहूं रोग का पता लगाने में विफल। कृपया पुनः प्रयास करें।',
    detectionResult: 'पता लगाने का परिणाम:',
  },
  th: {
    title: 'การตรวจจับโรคข้าวสาลี',
    analyzing: 'กำลังวิเคราะห์ภาพ...',
    error: 'ไม่สามารถตรวจจับโรคข้าวสาลีได้ กรุณาลองอีกครั้ง',

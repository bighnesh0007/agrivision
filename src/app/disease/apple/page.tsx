...
const translations =  {
    en: {
      ...
      error: 'Failed to detect apple disease. Please try again.',
      detectionResult: 'Detection Result:',
    },
    es: {
        title: 'एप्पल बीमारी का पता लगाना',
        analyzing: 'चित्र का विश्लेषण किया जा रहा है...',
        error: 'एप्पल बीमारी का पता लगाने में विफल। कृपया पुनः प्रयास करें।',
        detectionResult: 'पता लगाने का परिणाम:',
    },
    // Add more languages here
  };

export default function AppleDiseaseDetection() {
    ...
    const handleUpload = async (file: File) => {
        ...
        try {
            const response = await fetch("/api/disease/apple", {
                method: "POST",
                body: formData,
            });

            if (!response.ok) {
                throw new Error("Failed to detect apple disease");
            }

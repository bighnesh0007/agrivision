...
const translations = {
  en: {
    ...
    error: 'Failed to detect tomato disease. Please try again.',
    detectionResult: 'Detection Result:',
  },
  
  es: {
    title: 'टमाटर रोग पहचान',
    analyzing: 'चित्र का विश्लेषण किया जा रहा है...',
    error: 'टमाटर रोग का पता लगाने में विफल। कृपया पुनः प्रयास करें।',
    detectionResult: 'पता लगाने का परिणाम:',
  },
  th: {
    title: 'การตรวจจับโรคมะเขือเทศ',
    analyzing: 'กำลังวิเคราะห์ภาพ...',
    error: 'ไม่สามารถตรวจจับโรคมะเขือเทศได้ กรุณาลองอีกครั้ง',
    detectionResult: 'ผลการตรวจจับ:',
  },
};

export default function TomatoDiseaseDetection() {
    ...
    const handleUpload = async (file: File) => {
        ...
        try {
            const response = await fetch("/api/disease/tomato", {
                method: "POST",
                body: formData,
            });

...
const translations = {
  en: {
    ...
    error: 'Failed to detect Rice disease. Please try again.',
    detectionResult: 'Detection Result:',
  },

  es: {
    title: 'चावल रोग पहचान',
    analyzing: 'चित्र का विश्लेषण किया जा रहा है...',
    error: 'चावल रोग का पता लगाने में विफल। कृपया पुनः प्रयास करें।',
    detectionResult: 'पता लगाने का परिणाम:',
  },
  th: {
    title: 'การตรวจจับโรคข้าว',
    analyzing: 'กำลังวิเคราะห์ภาพ...',
    error: 'ไม่สามารถตรวจจับโรคข้าวได้ กรุณาลองอีกครั้ง',
...
export default function RiceDiseaseDetection() {
    ...
    const handleUpload = async (file: File) => {
        ...
        try {
            const response = await fetch("/api/disease/rice", {
                method: "POST",
                body: formData,
            });
